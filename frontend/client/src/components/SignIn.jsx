...
// import { loginProject } from '../actions/proejctActions';
...
//     const { loading, userData, error } = useSelector(state => state.loginProject);

//     const onChange = e => setFormData({ ...formData, [e.target.name]: e.target.value });

//     const clearData = () => setFormData({ email: '', password: '' });

//     const onSubmit = (e) => {
//         e.preventDefault();
//         dispatch(loginProject(formData));
//         clearData();
//     };
